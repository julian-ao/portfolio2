...
export const projects = [,
  ...
  {
    title: "Committee Application System",
    description:
      "Created a web application to make the process of applying to committees at Online easier for both the applicants and the committees. This platform helps organize and manage applications, automate interview-time selection, making the process simpler and more straightforward for everyone.",
    technologies: ["React", "Next.js", "MongoDB", "TailwindCSS"],
    images: [
      "./projects/opptak/landingPage.jpg",
      "./projects/opptak/applicationPage.jpg"
    ],
    typeOfImages: "desktop",
    link: "https://github.com/appKom/online-opptak",
